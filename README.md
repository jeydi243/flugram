...
# Demo
[Download the release APK to try out Flugram](https://github.com/mdanics/Flugram/raw/master/app-release.apk) 

I update Flugram with new features and bugs fixes, but the apk may be behind master. Take a look at the [changelog](/CHANGELOG.md) to see the most recent additions to the apk.
...
```sh
$ git clone https://github.com/mdanics/Flugram.git
$ cd Flugram/
```
...
_**If this does not work**  and you get the error `Error: Error parsing triggers: Cannot find module './notificationHandler'` Try following [these steps](https://github.com/mdanics/Flugram/issues/25#issuecomment-434031430). If you are still unable to get it to work please open a new issue._
...
# What's Next?
 ...
 - [X] Animations (heart when liking image) [(#77)](https://github.com/mdanics/Flugram/pull/77)
